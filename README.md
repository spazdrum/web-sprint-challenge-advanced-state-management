...
1. What problem does the context API help solve?
  ...
  It helps with state management

2. In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

  Actions - Are a way for you to dispatch commands to collect data
  Reducers - Where you pass data from your dispatch
  Store - Where your data lives and how you can disperse it through your project

3. What is the difference between Application state and Component state? When would be a good time to use one over the other?

  Application state is the overall state for the project, usually has to do with data you are rendering to the screen. Where as, Component state is data that only lives in a component.

4. Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

  redux-thunk allows you to return a function instead of an object from the action-creators, used more often with Asynchronous data.

5. What is your favorite state management system you've learned and this sprint? Please explain why!

  I enjoy using Redux, is allows me to simplify the data and seems to give a better underlying structure to React.
